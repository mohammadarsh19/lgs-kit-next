    ...
    <div className='mx-5 text-center my-6 md:min-h-110'>
      ...
      <div className='text-left md:mx-5'>
        <ol className='list-decimal mx-3'>
          <li>We are accepting payment via All types of Debit cards & Credit cards, Wallets etc.</li>
        ...
        <p><b>NOTE*</b> FOR MORE DETAILS CONTACT TO OUR SUPPORT TEAM <b>@lgsKit11@gmail.com</b></p>
      </div>
    </div>
  )
}
